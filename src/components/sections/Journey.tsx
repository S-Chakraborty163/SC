...
const skills = [
  ...
  { category: "ML/DL", items: ["PyTorch", "TensorFlow/Keras", "scikit-learn", "LoRA", "Ollama"] },
  ...
  { category: "RAG & GRAPH DBs", items: ["Neo4j", "ChromaDB", "DuckDB", "Pinecone"] },
  { category: "TOOLS", items: ["Git", "FastAPI", "Jupyter", "Colab"] },
              ...
              <Card className="bg-white/5 backdrop-blur-xl border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                <CardContent className="p-10 space-y-8">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                    <div>
                      <h3 className="text-2xl font-bold text-white">Summer Research Intern</h3>
                      <p className="text-primary font-medium">IIT Indore &mdash; Dept. of CSE (Advisor: Dr. Chandresh Kumar Maurya)</p>
                    </div>
                    <span className="text-white/40 text-[10px] font-bold uppercase tracking-[0.2em] pt-1">May 2026 – Jul 2026</span>
                  </div>
                  <ul className="space-y-4 text-base text-white/60 list-none">
                    <li className="flex gap-4">
                      <span className="text-primary font-bold">01</span>
                      <span>Designed a two-phase Graph-RAG system for Indian parliamentary policy analysis, combining DuckDB, ChromaDB, and Neo4j (76K+ entities, ~40M relationships)</span>
                    </li>
                    <li className="flex gap-4">
                      <span className="text-primary font-bold">02</span>
                      <span>Engineered a two-stage LoRA fine-tuning pipeline to produce sansad-v2 from a Mistral-7B base, quantized to 4-bit GGUF for local Ollama deployment</span>
                    </li>
                    <li className="flex gap-4">
                      <span className="text-primary font-bold">03</span>
                      <span>Built a double-blind LLM-as-a-judge evaluation pipeline (8 metrics, 150 questions) — sansad-v2 scored 92.89% Faithfulness and 91.18% Citation Accuracy, outperforming Llama 3.1 and Qwen 2.5</span>
                    </li>
                    <li className="flex gap-4">
                      <span className="text-primary font-bold">04</span>
                      <span>Deployed a Streamlit + Plotly analytics dashboard with concurrent multi-model inference via Cloudflare Workers AI</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
