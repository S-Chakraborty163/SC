...
const projects = [
  ...
  },
  {
    ...
    description: "Building an end-to-end Graph-RAG system for Indian parliamentary policy analysis, combining DuckDB, ChromaDB, and Neo4j with a custom LoRA fine-tuned Mistral-7B model. Ongoing research internship project at IIT Indore, under Dr. Chandresh Kumar Maurya.",
    highlights: [
